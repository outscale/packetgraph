...
for n in build-core build-brick-diode build-brick-print build-brick-firewall build-brick-hub build-brick-nic build-brick-switch build-brick-vhost build-brick-vtep; do
	build=$p/$n
	mkdir $build | true
	cd $build
