...
bench_HEADERS = $(PG_dev_HEADERS)
bench_LDFLAGS = -lpacketgraph-dev $(PG_dev_LIBADD) -L$(srcdir) -ldl -lm -lnuma -lpthread -lpcap -lz
...
bench_dependencies: dev bench-antispoof bench-core bench-diode bench-firewall bench-nic bench-print bench-queue bench-switch bench-vhost bench-pmtud bench-vtep bench-tap bench-rxtx bench-ip-fragment
