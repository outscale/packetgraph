...
check_PROGRAMS = tests-antispoof tests-core tests-diode tests-accumulator tests-rxtx tests-firewall tests-integration tests-nic tests-print tests-queue tests-switch tests-vhost tests-vtep  tests-pmtud tests-tap tests-ip-fragment tests-thread
